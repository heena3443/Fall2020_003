...
public class TravelDestination {
    ...
    //Print Statement with full name and hobby
		...
		// Print statement with full name and hobby
		System.out.println("My name is Ryan Freeman. I enjoy running.");
		
		// Print statement with full name and hobby
		System.out.println("My name is Farhan Hassan. I like to play basketball.");
		//Print statement with full name and hobby.
		System.out.println("My name is Tuan Nguyen and I like to play soccer");
		
		System.out.println("My name is Luke Overbey and I like building custom keyboards");
		
		//Print statement with full name and hobby
		System.out.println("My name is Alejadro Navarro and I like making music.");
		
		//Print statement with full name and hobby
		System.out.println("My name is Jonas English, and I like listening to progressive music.");
		
		//Print statement with full name and hobby
		System.out.println("My name is Alan Weikman, and I like to workout.");
		
		//Print statement with full name and hobby
		System.out.println("My name is Isabel Madrigal, and I like to hike and travel.");
		
		//Print statement with full name and hobby
		System.out.println("My name is Josh Domingo, and I like to workout and play the guitar");
    
		//Print statement with full name and hobby
		System.out.println("My name is Edgar Carmona, and I like to play challenging video games.");
	}
